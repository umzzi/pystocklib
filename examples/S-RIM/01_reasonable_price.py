...
today = date.today()
with open('/Users/umzzi/dev/stock/srim/examples/S-RIM/S-RIM_전종목_' + today.strftime("%Y%m%d") + '.txt', mode='w+',
          encoding='utf-8') as f:
    f.write("code, codeName, curPrice, 싼가?, 20%이익감소가대비, 적정주가, 10%이익 감소가, 20%이익 감소가, ROE, 요구수익률(BBB-5년 회사채)\n")
